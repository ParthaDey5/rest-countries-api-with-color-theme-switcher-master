...
function Navbar() {
  ...
  return (
    <div>
      <nav
        className={`fixed top-0 inset-y-0 !z-50 border-b-[40px] overflow-x-hidden 2xl:py-[2dvw] sm:py-[1.4dvw] py-[6dvw] sm:px-[5dvw] px-[4dvw] shadow flex justify-between transition-colors duration-400 ease-linear ${
