...
function CountryDetails() {
  ...
  return (
    <div
      id="bg" 
      className={`mt-[15dvw] sm:mt-auto max-w-screen min-h-screen transition-colors duration-400 ease-linear ${darkMode ? 'Blue950' : 'Grey50'}`}
    >
      <section className="sm:px-[5dvw] px-[10dvw] sm:py-16 pt-[6dvw]">
        <Link className="inline-flex w-auto" to="/">
          <button className="button-back dark:bg-[#2b3945] bg-[hsl(0, 0%, 99%)]   hover:bg-red-600 hover:scale-111 transition-all duration-0 hover:duration-700 cursor-pointer sm:px-[2dvw] px-[5dvw] sm:py-[0.6dvw] py-[2.1dvw] rounded-[5%] nunito-sans-600 shadow-fluid flex items-center 2xl:gap-4 sm:gap-[1dvw] gap-[2dvw]">
